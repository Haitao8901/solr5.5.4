 ...
 // private ClientConnectionManager clientConnectionManager = new PoolingClientConnectionManager();
  ...
  public void load()  {
    ...
    try {
      ...
      final boolean fromLoadMethod = true;
  ...
  /**
   * Need to be overrider in the subclass if you have overrided the create method.
   * */
  protected SolrCore createFromLoad(CoreDescriptor dcore, boolean publishState) {
	  return create(dcore, publishState);
  }
