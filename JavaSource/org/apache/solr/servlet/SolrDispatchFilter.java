...
import solr.CyberCoreContainer;
...
public class SolrDispatchFilter extends BaseSolrFilter {
  ...
  public static final String SOLR_CONFIG_PATH = "configPath";
  ...
  public void init(FilterConfig config) throws ServletException
  {
    ...
    try {
      ...
      //under ${cyberobject.home}/cyberSolr/SolrConfig
      String defaultConfigPath = config.getServletContext().getInitParameter(SOLR_CONFIG_PATH);
      
//      this.cores = createCoreContainer(solrHome == null ? SolrResourceLoader.locateSolrHome() : Paths.get(solrHome),
//                                       extraProperties);
      this.cores = createCoreContainer(solrHome == null ? SolrResourceLoader.locateSolrHome() : Paths.get(solrHome),
    		  extraProperties, defaultConfigPath);
   ...
   */
  protected CoreContainer createCoreContainer(Path solrHome, Properties extraProperties, String defaultConfigPath) {
    NodeConfig nodeConfig = loadNodeConfig(solrHome, extraProperties);
//    cores = new CoreContainer(nodeConfig, extraProperties, true);
    cores = new CyberCoreContainer(defaultConfigPath, nodeConfig, extraProperties, true);
    cores.load();
    return cores;
  }
