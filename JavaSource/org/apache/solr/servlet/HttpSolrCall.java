...
public class HttpSolrCall {
  ...
  public HttpSolrCall(CoreContainer cores, HttpServletRequest request, HttpServletResponse response, boolean retry) {
	  this.solrDispatchFilter = null;
	  this.cores = cores;
	  this.req = request;
	  this.response = response;
	  this.retry = retry;
  ...
  public Action call() throws IOException {
    ...
    if (solrDispatchFilter != null && solrDispatchFilter.abortErrorMessage != null) {
